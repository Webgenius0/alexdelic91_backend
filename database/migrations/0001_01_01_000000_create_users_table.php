...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->boolean('is_notices')->default(true)->nullable();
            $table->boolean('is_messages')->default(true)->nullable();
            $table->boolean('is_likes')->default(true)->nullable();
            $table->boolean('safety_mode')->default(true)->nullable();
            $table->rememberToken();
            $table->timestamps();
        });
