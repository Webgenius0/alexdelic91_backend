        ...
        <div class=" container-fluid  d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted"> FAQ </li><li class="breadcrumb-item text-muted"> Edit </li>
                        ...
                        <form method="POST" action="{{ route('admin.faq.update', $faq->id) }}">
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <input type="text" placeholder="Enter Question" id="question"
                                    ...
                                    value="{{ $faq->question ?? old('question') }}" />
                                @error('question')
                            ...
                            <div class="input-style-1 mt-4">
                                ...
                                <textarea name="answer" id="answer" rows="7" class="form-control @error('answer') is-invalid @enderror">{{ $faq->answer ?? old('answer') }}</textarea>
                                @error('answer')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
