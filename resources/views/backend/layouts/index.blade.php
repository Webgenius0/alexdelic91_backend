...
@section('content')
    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                <div class="mt-4 col-12 col-md-4 col-lg-3">
                    <div class="card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                <h1 class="text-gray-800 fs-2hx fw-bold me-2 lh-1">2</h1>
                                <h4 class="mt-5 text-gray-400 fs-4 fw-semibold">Total Users</h4>
                            </div>
                            <div>
                ...
                <div class="mt-4 col-12 col-md-4 col-lg-3">
                    <div class="card">
                        <div class="card-body d-flex justify-content-between">
                            <div>
                                <h1 class="text-gray-800 fs-2hx fw-bold me-2 lh-1">2</h1>
                                <h4 class="mt-5 text-gray-400 fs-4 fw-semibold">Total Blog</h4>
                            </div>
                            <div>
